...
class BurgersNormDataset(Dataset):
    """Custom dataset for Normalized Burgers 1D equation data."""
...
def load_data(params, device, split="train"):
    ...
    model_dataset = BurgersNormDataset(ds, stats, device=device)
