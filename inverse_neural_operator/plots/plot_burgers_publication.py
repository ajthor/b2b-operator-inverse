...
- 2x4 input grid + 2x2 re-simulation grid
...
def plot_comparison(
    ...
    s_min, s_max = s_true.min(), s_true.max()
    ...
    # Plot input reconstructions (left 2x4 grid)
    ...
    if save_dir:
        ...
        base = os.path.join(save_dir, f"burgers_comparison_sample_{sample_idx}")
