...
def visualize_ifno_results(
    model_path, n_samples=3, save_dir="results/ifno_plots_darcy/"
):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Visualize IFNO results on Darcy 1D dataset"
    )
    parser.add_argument(
        "--model_path",
        type=str,
        default="logs_ifno/darcy_1d/seed_1/ifno_model.pth",
