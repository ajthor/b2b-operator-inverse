...
def visualize_ifno_results(model_path, n_samples=3, save_dir="results/ifno_plots_darcy/"):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='results/ifno_plots_darcy/',
