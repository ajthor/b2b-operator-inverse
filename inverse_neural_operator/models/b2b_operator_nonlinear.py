...
def load(path, input_size, hidden_sizes, output_size, device=None):
    """
    ...
    Returns:
        Loaded NonlinearB2BOperator instance
    """
...
def load_checkpoint(path, input_size, hidden_sizes, output_size, optimizer=None, device=None):
    """
