...
# MODELS=(b2b_linear b2b_nonlinear variational_autoencoder deeponet inn_additive cinn_additive inn_affine cinn_affine)
DATASETS=(burgers_1d)
MODELS=(inn_additive cinn_additive inn_affine cinn_affine mixture_density_network)
